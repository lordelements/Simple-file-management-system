    ...
    <ul class="d-flex align-items-center">
      ...
      <?php
         include "../connnection/config.php";
          ...
          $sql = "SELECT firstname, middlename, lastname, profile_img FROM `table_register_acc` WHERE username='$username'";
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <a class="nav-link nav-profile align-items-center pe-0" href="#">
                <img src="<?php echo $file_path ?>" alt="Profile" class="rounded-circle">
              </a><!-- End Profile Iamge Icon -->
