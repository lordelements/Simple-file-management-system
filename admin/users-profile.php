                ...
                <form method="post" action="functions/editprofileFunct.php">
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <img src="<?php echo $file_path ?>" alt="Profile" class="image-fluid" width="300" height="300">
                      <div class="pt-2">
                        <a href="updateprofile_pic.php? update_pic=<?php echo $user_id ?>" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload"></i></a>
                      </div>
                    </div>
                  </div>
